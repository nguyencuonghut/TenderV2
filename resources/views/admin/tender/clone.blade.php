    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                    <form class="form-horizontal" method="post" action="{{ route('admin.tenders.postCloneTender', $tender->id) }}" name="clone_tender" id="clone_tender" novalidate="novalidate">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="control-group">
                                <div class="controls">
                                    <input type="submit" value="Tạo bản copy" class="btn btn-success">
                                </div>
                            </div>
                        <div>
                    </form>
